...
This script reads {SRC,SRCPKG,PKG,LOG}DEST, NPROC, MAKEFLAGS and PACKAGER
from makepkg.conf(5), if those variables are not part of the
environment. GIT_{AUTHOR,COMMITTER}_{NAME,EMAIL} are derived from PACKAGER
